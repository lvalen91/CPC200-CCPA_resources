...
.method public n()Ljava/lang/Object;
    ...
    .line 1
    iget-object v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->m:Ljava/lang/Object;
    ...
    .line 2
    iget-object v2, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->j:Ljava/util/List;
    ...
    .line 5
    invoke-virtual {v3}, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->k()Ljava/lang/Object;
    ...
    iget-wide v5, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->c:J

    iget-wide v7, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->d:J

    iget v9, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->e:F

    iget-wide v10, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->f:J

    iget-object v12, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->h:Ljava/lang/CharSequence;

    iget-wide v13, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->i:J

    iget-wide v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->k:J

    iget-object v3, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->l:Landroid/os/Bundle;

    move-wide/from16 v16, v1

    move-object/from16 v18, v3

    invoke-static/range {v4 .. v18}, Landroid/support/v4/media/session/h;->b(IJJFJLjava/lang/CharSequence;JLjava/util/List;JLandroid/os/Bundle;)Ljava/lang/Object;

    move-result-object v1

    iput-object v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->m:Ljava/lang/Object;
    ...
    invoke-static/range {v4 .. v17}, Landroid/support/v4/media/session/g;->j(IJJFJLjava/lang/CharSequence;JLjava/util/List;J)Ljava/lang/Object;

...
public final class i {
    ...
    private static class a implements ActionMode.Callback {
        ...
        private void f(Menu menu) {
            Context context = this.f632b.getContext();
            ...
            if (!this.f) {
                ...
                try {
                    ...
                    this.f633c = cls;
                    this.f634d = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                    this.e = true;
            ...
            try {
                Method declaredMethod = (this.e && this.f633c.isInstance(menu)) ? this.f634d : menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE);
                ...
                for (int i = 0; i < listC.size(); i++) {
                    ...
                    menu.add(0, 0, i + 100, resolveInfo.loadLabel(packageManager)).setIntent(b(resolveInfo, this.f632b)).setShowAsAction(1);
                }
    ...
    public static void m(TextView textView, c.g.i.c cVar) {

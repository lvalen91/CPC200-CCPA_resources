...
class y extends z {
    ...
    class b implements Transition.TransitionListener {
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            for (int i = 0; i < size; i++) {
                ((View) this.f794b.get(i)).setVisibility(0);
            }
        }
    ...
    class c implements Transition.TransitionListener {
        ...
        final /* synthetic */ Object f796c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        final /* synthetic */ ArrayList f797d;
        ...
        public void onTransitionStart(Transition transition) {
            Object obj = this.a;
            if (obj != null) {
                y.this.q(obj, this.f795b, null);
            }
            Object obj2 = this.f796c;
            if (obj2 != null) {
                y.this.q(obj2, this.f797d, null);
            }
            Object obj3 = this.e;
            if (obj3 != null) {
                y.this.q(obj3, this.f, null);
            }
        }
    }

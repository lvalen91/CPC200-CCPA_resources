...
public class UCropActivity extends d {
    ...
    private void setupAppBar() {
        ...
        Drawable drawableMutate = a.d(this, R.drawable.ucrop_ic_cross).mutate();
    ...
    private void setupViews(Intent intent) {
        ...
        this.mActiveWidgetColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_COLOR_WIDGET_ACTIVE, a.b(this, R.color.ucrop_color_widget_active));

...
public class ForegroundService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        cn.manstep.phonemirrorBox.util.s.c("ForegroundService,onCreate: ######");
    }

    @Override // android.app.Service
    public void onDestroy() {
        super.onDestroy();
        cn.manstep.phonemirrorBox.util.s.c("ForegroundService,onLowMemory: ######");
    }
    ...
    public void onTrimMemory(int i) {
        ...
        cn.manstep.phonemirrorBox.util.s.c("ForegroundService,onTrimMemory: level = " + i);
    }
}

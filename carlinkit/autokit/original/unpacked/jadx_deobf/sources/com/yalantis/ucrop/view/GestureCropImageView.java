...
public class GestureCropImageView extends CropImageView {
    ...
    /* JADX INFO: renamed from: com.yalantis.ucrop.view.GestureCropImageView$1 */
    ...
    private class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        /* synthetic */ GestureListener(GestureCropImageView gestureCropImageView, C11861 c11861) {
            this();
        }
    }
    ...
    private class RotateListener extends RotationGestureDetector.SimpleOnRotationGestureListener {
        ...
        /* synthetic */ RotateListener(GestureCropImageView gestureCropImageView, C11861 c11861) {
            this();
        }
    }
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        /* synthetic */ ScaleListener(GestureCropImageView gestureCropImageView, C11861 c11861) {
            this();
        }
    }
    ...
    private void setupGestureListeners() {
        C11861 c11861 = null;
        this.mGestureDetector = new GestureDetector(getContext(), new GestureListener(this, c11861), null, true);
        this.mScaleDetector = new ScaleGestureDetector(getContext(), new ScaleListener(this, c11861));
        this.mRotateDetector = new RotationGestureDetector(new RotateListener(this, c11861));
    }

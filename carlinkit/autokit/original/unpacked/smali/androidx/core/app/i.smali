...
.method public static d(Landroid/content/Context;)Landroidx/core/app/i;
  .registers 2
  .line 1
...
.method public a(Landroid/content/Intent;)Landroidx/core/app/i;
  .registers 3
  .line 1
...
.method public b(Landroid/app/Activity;)Landroidx/core/app/i;
  .registers 3
  .line 1
    instance-of v0, p1, Landroidx/core/app/i$a;
    if-eqz v0, :L0
  .line 2
    move-object v0, p1
    check-cast v0, Landroidx/core/app/i$a;
    invoke-interface { v0 }, Landroidx/core/app/i$a;->getSupportParentActivityIntent()Landroid/content/Intent;
  ...
  :L3
  .line 6
    invoke-virtual { p0, p1 }, Landroidx/core/app/i;->c(Landroid/content/ComponentName;)Landroidx/core/app/i;
  .line 7
    invoke-virtual { p0, v0 }, Landroidx/core/app/i;->a(Landroid/content/Intent;)Landroidx/core/app/i;
  :L4
    return-object p0
.end method

.method public c(Landroid/content/ComponentName;)Landroidx/core/app/i;
  .catch Landroid/content/pm/PackageManager$NameNotFoundException; { :L0 .. :L2 } :L4
  .registers 4
  .line 1
    iget-object v0, p0, Landroidx/core/app/i;->b:Ljava/util/ArrayList;
  ...
  :L1
    if-eqz p1, :L3
  .line 3
    iget-object v1, p0, Landroidx/core/app/i;->b:Ljava/util/ArrayList;
...
.method public e()V
  .registers 2
    const/4 v0, 0
  .line 1
    invoke-virtual { p0, v0 }, Landroidx/core/app/i;->f(Landroid/os/Bundle;)V
    return-void
.end method

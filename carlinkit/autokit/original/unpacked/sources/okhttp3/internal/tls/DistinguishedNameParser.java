...
final class DistinguishedNameParser {
    ...
    */
    ...
    private int getByte(int i) {
        ...
        int i4 = i + 1;
        if (i4 >= this.length) {
            throw new IllegalStateException("Malformed DN: " + this.f8017dn);
        }
    ...
    private char getEscaped() {
        ...
        this.pos = i;
        if (i == this.length) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f8017dn);
        }
        char c2 = this.chars[i];
    ...
    */
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f8017dn.toCharArray();

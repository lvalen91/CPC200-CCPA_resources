...
public class AlertDialogLayout extends C0167g0 {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* JADX INFO: renamed from: A */
    private void m889A(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* JADX INFO: renamed from: B */
    private static int m890B(View view) {
        int iM2048D = C0292v.m2048D(view);
        if (iM2048D > 0) {
            return iM2048D;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m890B(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    private boolean m891C(int i, int i2) {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0498f.topPanel) {
                    view = childAt;
                } else if (id == C0498f.buttonPanel) {
                    view2 = childAt;
                } else {
                    if ((id != C0498f.contentPanel && id != C0498f.customPanel) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            view2.measure(i, 0);
            iM890B = m890B(view2);
            measuredHeight = view2.getMeasuredHeight() - iM890B;
            paddingTop += iM890B;
        ...
        if (view2 != null) {
            int i5 = paddingTop - iM890B;
            int iMin = Math.min(i4, measuredHeight);
            if (iMin > 0) {
                i4 -= iMin;
                iM890B += iMin;
            }
            view2.measure(i, View.MeasureSpec.makeMeasureSpec(iM890B, 1073741824));
    ...
    private void m892l(int i, int i2) {
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0167g0.a aVar = (C0167g0.a) childAt.getLayoutParams();
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                if (iM1883b == 1) {
                    ...
                    m889A(childAt, i7, i13, measuredWidth, measuredHeight2);
                ...
                m889A(childAt, i7, i132, measuredWidth, measuredHeight2);

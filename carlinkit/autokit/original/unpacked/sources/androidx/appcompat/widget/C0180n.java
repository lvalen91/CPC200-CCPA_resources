...
public class C0180n extends MultiAutoCompleteTextView implements InterfaceC0291u {

    /* JADX INFO: renamed from: d */
    private static final int[] f1210d = {R.attr.popupBackground};

    /* JADX INFO: renamed from: b */
    private final C0162e f1211b;

    /* JADX INFO: renamed from: c */
    private final C0198w f1212c;

    public C0180n(Context context, AttributeSet attributeSet) {
    ...
    protected void drawableStateChanged() {
        ...
        C0162e c0162e = this.f1211b;
        if (c0162e != null) {
            c0162e.m1091b();
        }
        C0198w c0198w = this.f1212c;
        if (c0198w != null) {
            c0198w.m1364b();
        }
    }
    ...
    public C0180n(Context context, AttributeSet attributeSet, int i) {
        super(C0189r0.m1286b(context), attributeSet, i);
        C0185p0.m1279a(this, getContext());
        C0195u0 c0195u0M1321v = C0195u0.m1321v(getContext(), attributeSet, f1210d, i, 0);

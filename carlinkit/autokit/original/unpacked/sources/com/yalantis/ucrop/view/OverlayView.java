...
public class OverlayView extends View {
    ...
    private void initCropFrameStyle(TypedArray typedArray) {
        int dimensionPixelSize = typedArray.getDimensionPixelSize(C1176R.styleable.ucrop_UCropView_ucrop_frame_stroke_size, getResources().getDimensionPixelSize(C1176R.dimen.ucrop_default_crop_frame_stoke_width));
        int color = typedArray.getColor(C1176R.styleable.ucrop_UCropView_ucrop_frame_color, getResources().getColor(C1176R.color.ucrop_color_default_crop_frame));
    ...
    private void initCropGridStyle(TypedArray typedArray) {
        int dimensionPixelSize = typedArray.getDimensionPixelSize(C1176R.styleable.ucrop_UCropView_ucrop_grid_stroke_size, getResources().getDimensionPixelSize(C1176R.dimen.ucrop_default_crop_grid_stoke_width));
        int color = typedArray.getColor(C1176R.styleable.ucrop_UCropView_ucrop_grid_color, getResources().getColor(C1176R.color.ucrop_color_default_crop_grid));
        this.mCropGridPaint.setStrokeWidth(dimensionPixelSize);
        this.mCropGridPaint.setColor(color);
        this.mCropGridRowCount = typedArray.getInt(C1176R.styleable.ucrop_UCropView_ucrop_grid_row_count, 2);
        this.mCropGridColumnCount = typedArray.getInt(C1176R.styleable.ucrop_UCropView_ucrop_grid_column_count, 2);
    }
    ...
    protected void processStyledAttributes(TypedArray typedArray) {
        this.mCircleDimmedLayer = typedArray.getBoolean(C1176R.styleable.ucrop_UCropView_ucrop_circle_dimmed_layer, false);
        int color = typedArray.getColor(C1176R.styleable.ucrop_UCropView_ucrop_dimmed_color, getResources().getColor(C1176R.color.ucrop_color_default_dimmed));
        ...
        this.mShowCropFrame = typedArray.getBoolean(C1176R.styleable.ucrop_UCropView_ucrop_show_frame, true);
        initCropGridStyle(typedArray);
        this.mShowCropGrid = typedArray.getBoolean(C1176R.styleable.ucrop_UCropView_ucrop_show_grid, true);
    }
    ...
    public OverlayView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mPreviousTouchY = -1.0f;
        this.mCurrentTouchCornerIndex = -1;
        this.mTouchPointThreshold = getResources().getDimensionPixelSize(C1176R.dimen.ucrop_default_crop_rect_corner_touch_threshold);
        this.mCropRectMinSize = getResources().getDimensionPixelSize(C1176R.dimen.ucrop_default_crop_rect_min_size);
        this.mCropRectCornerTouchAreaLineLength = getResources().getDimensionPixelSize(C1176R.dimen.ucrop_default_crop_rect_corner_touch_area_line_length);
        init();
    }
}

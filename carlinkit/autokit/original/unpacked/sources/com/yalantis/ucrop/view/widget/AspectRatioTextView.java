...
public class AspectRatioTextView extends TextView {
    ...
    private void applyActiveColor(int i) {
        ...
        setTextColor(new ColorStateList(new int[][]{new int[]{R.attr.state_selected}, new int[]{0}}, new int[]{i, C0242a.m1697b(getContext(), C1176R.color.ucrop_color_widget)}));
    }

    private void init(TypedArray typedArray) {
        setGravity(1);
        this.mAspectRatioTitle = typedArray.getString(C1176R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_title);
        this.mAspectRatioX = typedArray.getFloat(C1176R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_x, CropImageView.DEFAULT_ASPECT_RATIO);
        float f = typedArray.getFloat(C1176R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_y, CropImageView.DEFAULT_ASPECT_RATIO);
        ...
        this.mDotSize = getContext().getResources().getDimensionPixelSize(C1176R.dimen.ucrop_size_dot_scale_text_view);
        Paint paint = new Paint(1);
        this.mDotPaint = paint;
        paint.setStyle(Paint.Style.FILL);
        setTitle();
        applyActiveColor(getResources().getColor(C1176R.color.ucrop_color_widget_active));
        typedArray.recycle();
    }
    ...
    public AspectRatioTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        init(context.obtainStyledAttributes(attributeSet, C1176R.styleable.ucrop_AspectRatioTextView));
    }

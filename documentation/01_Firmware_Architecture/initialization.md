...
- `/var/lib/lockdown/*` records are **usbmuxd USB-trust / iOS host-pairing records, not MFi credentials** — do not conflate them with the MFi auth path. See `05_Security_Analysis/security_findings.md` §5 (canonical lockdown-vs-MFi distinction).
...
- Firmware: `_evidence/cpc200_ccpa_firmware_binaries/`

...
> **Note — ARMimg_maker is NOT removed in 2025.10.15:** An earlier analysis claimed ARMimg_maker was removed in 2025.10.15; this is superseded. The binary is confirmed present in the **2025.02 and 2025.10 extracted rootfs**. The removal claim is retracted (so 2025.10.15 has no ARMimg_maker removal entry); the confirmed presence still warrants independent re-verification.
...
- Firmware binaries: `an offline archive of the older firmware binaries`

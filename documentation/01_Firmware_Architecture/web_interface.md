...
| **IP Address (USB NCM)** | `http://192.168.50.2` |
| **Port** | 80 |
...
```json
{
  ...
  // UDiskPassThrough, FastConnect, ImprovedFluency (dead key — see configuration.md), KnobMode, MouseMode,
...
5. **Command Injection** - Prior firmware versions vulnerable via wifiName/btName (see `security_findings.md`)

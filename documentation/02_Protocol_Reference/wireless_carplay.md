...
iPhone advertises  :  _carplay-ctrl._tcp.local.   (e.g. User._carplay-ctrl._tcp, :49372)
```
...
|-----|-------|-------------|
| deviceid | DE:AD:BE:EF:00:01 | Adapter device ID |
...
- Source: `GM_research/_evidence/cpc200_research/CLAUDE.md`

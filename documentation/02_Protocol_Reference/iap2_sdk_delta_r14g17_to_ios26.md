...
**Reference binaries:** the iOS 26.5 `AccessoryNavigation`, `CarKit`, `CoreAccessories`, `AccessoryiAP2Shim`, and `CarKitNavigation` frameworks
...
|---|---|
| `supportsCarPlay`, `supportsWirelessCarPlay`, `supportsUSBCarPlay` | _(USB CarPlay relevant for USB-C iPhones)_ |

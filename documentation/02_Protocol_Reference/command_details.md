...
- **A→H (24-byte payload):** Adapter notifying host of connected phone's Bluetooth MAC address

**Binary Evidence:**
- String at `0x6b8f3`: `"DisableBluetooth"`
- Extended format (24 bytes) contains BT MAC at offset 4
...
21      3     Additional data (possibly year, e.g. e8 07 00 = 2024; unconfirmed)
```
...
- 508 (RequestNaviScreenFocus) — three-step handshake (discovered 2026-05-28 via live RE; see `video_protocol.md` "Handshake Sequence"):
  ...
  - Live-verified on carlink_native + CPC200-CCPA firmware 2025.10.15.1127 (wireless CarPlay). (Note: `carplay_handshake.md` reports firmware 2025.02.25 for its 2026-05-21 capture; both 2025.02.25 and 2025.10.15.1127 are genuine CCPA firmware releases — label which firmware each capture used.)

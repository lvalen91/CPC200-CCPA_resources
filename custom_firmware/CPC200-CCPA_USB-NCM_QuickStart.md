...
- **Do NOT disable WiFi/Bluetooth** to "force NCM only." If NCM then fails to come up you lose all
  access and recovery requires a hardware flash programmer. Keep WiFi as your backstop.
